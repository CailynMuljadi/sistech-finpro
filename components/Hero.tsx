          ...
          <div className="flex flex-wrap items-center gap-4 mb-10 w-full sm:w-auto">
            ...
            <Show when="signed-out">
              <SignUpButton mode="modal">
                <button className="w-full sm:w-auto text-center px-7 py-3.5 rounded-xl bg-[#17274d] text-white font-bold text-sm shadow-md hover:bg-[#17274d]/90 transition-all cursor-pointer">
                  Mulai Sekarang
                </button>
              </SignUpButton>
            </Show>
