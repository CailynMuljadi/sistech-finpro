...
export default function AnonymousReportingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Main Content */}
      <main className="flex-1 bg-[#ffeff7] px-3 sm:px-6 py-6 sm:py-12 font-sans overflow-x-hidden text-[#17274d]">
        <div className="max-w-[1100px] mx-auto bg-white rounded-2xl shadow-lg p-4 sm:p-10 box-border overflow-x-hidden">
          ...
          <div className="mb-6 border-b border-[#ffeff7] pb-4">
            <h1 className="text-xl sm:text-3xl font-bold text-[#17274d] flex items-center gap-2.5">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <button
              ...
              disabled={submitting}
              className={`
                w-full py-4 px-6 bg-[#17274d] text-white rounded-xl
                font-bold text-sm tracking-wider uppercase transition mt-6
                ${
                  submitting
                    ? 'cursor-not-allowed opacity-70'
                    : 'cursor-pointer hover:bg-[#17274d]/90'
                }
              `}
            >
